...
public class Drivetrain extends Subsystem {
    ...
    SpeedController leftDriveVictors = RobotMap.drivetrainLeftDriveVictors;
    Encoder leftDriveEncoder = RobotMap.drivetrainLeftDriveEncoder;
    PIDController leftDrive = RobotMap.drivetrainLeftDrive;
    SpeedController rightDriveVictors = RobotMap.drivetrainRightDriveVictors;
    Encoder rightDriveEncoder = RobotMap.drivetrainRightDriveEncoder;
    PIDController rightDrive = RobotMap.drivetrainRightDrive;
