...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("OSHA Stop", new OSHAStop());
        ...
        SmartDashboard.putData("Climb Pyramind", new ClimbPyramid());
    ...
    public static void setLED(int channel, boolean enabled){
        try{
            DriverStation.getInstance().getEnhancedIO().setDigitalOutput(channel, !enabled);
        }
        catch(Exception ex) {}
    }
